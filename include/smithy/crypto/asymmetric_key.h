...
// Creates new keypair - allocates memory in the br_ structures that should be freed
...
// To free only one of the two keys, pass in NULL for the other.
...
// cert_chain's trust store as a trust anchor. The certificate is in DER format,
// to get PEM format just b64 encode.
